...
/**
 * Created by Schnappi on 21.03.2018.
 */
  ...
  /*  private static final String[] CAMERA_PERMISSIONS = {
    ...
    private final ImageReader.OnImageAvailableListener mOnImageAvailableListener
        ...
        public void onImageAvailable(ImageReader reader) {
            ...
            File mediaStorageDir = new File(pathD, "FjordLineAR");
            if (!mediaStorageDir.exists()) {
                if (!mediaStorageDir.mkdirs()) {
                    Log.d("Fjord Line AR", "failed to create directory");
                }
            }
        ...
        from onActivityCreated and add here with the new path from my Album*/
            ...
            mFile = new File(mediaStorageDir, "FjordLineAR_" + timeStamp + ".jpeg");

            //Then the contentValues
            ContentValues values = new ContentValues();
            values.put(MediaStore.Images.Media.TITLE, "FjordLineAR");
            values.put(MediaStore.Images.Media.DATE_TAKEN, System.currentTimeMillis());
            values.put(MediaStore.Images.Media.ORIENTATION, ORIENTATIONS.get(mSensorOrientation));
