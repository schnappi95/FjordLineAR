 ...
 */
package com.gruppe22.fjordlinear.rendering;
...
import com.gruppe22.fjordlinear.R;
...
public class ObjectRenderer extends Renderer {
    ...
    public ObjectRenderer(String objAssetName,
                          String diffuseTextureAssetName) {
        this.objAssetName = objAssetName;
        this.diffuseTextureAssetName = diffuseTextureAssetName;
    }

    private String objAssetName,
